...
namespace GameStore
{
    ...
    public class CsvService
    {
        ...
        {
            string path = Path.Combine(this.folderPath, "games.csv");
        ...
        /// </summary>
        /// <param name="g">Об'єкт гри з оновленими даними.</param>
        ...
        {
            string path = Path.Combine(this.folderPath, "clients.csv");
        ...
        /// </summary>
        /// <param name="c">Клієнт для оновлення.</param>
        ...
        {
            string path = Path.Combine(this.folderPath, "orders.csv");
        ...
        /// </summary>
        /// <param name="orders">Список замовлень для збереження.</param>
        ...
        {
            string path = Path.Combine(this.folderPath, "users.csv");
        ...
        /// <returns>Об'єкт користувача або null.</returns>
